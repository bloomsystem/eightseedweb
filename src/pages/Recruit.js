        ...
        <Row className="justify-content-center">
          <Col md="8" className="py-5">
            ...
            <div className="text-basic">
              ...
              <p>
                極論、スケジューリングやリスクヘッジがきちんとできており何日も前倒しでプロジェクトが進められている場合、浮いた時間を休暇に当てることも可能です。
                <br />
              </p>
              <p>
              ...
              <p>
                スタッフの豊かな人生を第一に考えることで、仕事においては最大限のパフォーマンスを発揮し、結果としてお客様の満足に繋がると考えております。
              </p>
              <h2 className="fw-bold text-accent mt-5 mb-4">
                お客様の想いの本質を考える
              </h2>
              ...
              <p>
                主にフロントエンドエンジニア(React, Vue)が即戦力となります。
              </p>
              <p>
                フロントエンド界隈ではない場合においても、自己の精通している領域を高め必要性をアピールできる方はぜひお問合せください。
              </p>
              <p>
                また、私たちの思想に共感していただける場合、コミュニケーション能力、向上心、誠実さがあれば技術は後追いでも構いません。
              </p>
            </div>
          </Col>
        </Row>
